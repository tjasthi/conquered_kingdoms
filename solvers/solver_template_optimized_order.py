...
def solve(list_of_kingdom_names, starting_kingdom, adjacency_matrix, file, params=[]):
    ...
    max_cycle_list = [2, 3]
    conquered_weight_list = [conquer_average * 0.5, conquer_average, conquer_average * 1.5]
    distance_weight_list = [distance_average * 0.5, distance_average, distance_average * 1.5]
    kingdom_benefit_list = [(conquer_average + distance_average) / 4, (conquer_average + distance_average) / 2, conquer_average + distance_average] + \
        [conquer_average] + \
            [distance_average]
    unconquered_benefit_list = [0, distance_average * 0.5, distance_average]
    unconquered_penalty_list = [0, distance_average * 0.5, distance_average]
